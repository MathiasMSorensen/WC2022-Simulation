...
def get_group_stage_odds(API_KEY):
    ...
    for i in range(len(df)):
        ...
        if len(df.loc[i,"bookmakers"])>0:
            if df.loc[i,"home_team"]==df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][0]["name"]:
                df.loc[i,"1"] = df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][0]["price"]
            elif df.loc[i,"away_team"]==df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][0]["name"]:
                df.loc[i,"2"] = df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][0]["price"]
            else:
                df.loc[i,"X"] = df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][0]["price"]
            
            if df.loc[i,"home_team"]==df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][1]["name"]:
                df.loc[i,"1"] = df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][1]["price"]
            elif df.loc[i,"away_team"]==df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][1]["name"]:
                df.loc[i,"2"] = df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][1]["price"]
            else:
                df.loc[i,"X"] = df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][1]["price"]
                
            if df.loc[i,"home_team"]==df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][2]["name"]:
                df.loc[i,"1"] = df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][2]["price"]
            elif df.loc[i,"away_team"]==df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][2]["name"]:
                df.loc[i,"2"] = df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][2]["price"]
            else:
                df.loc[i,"X"] = df.loc[i,"bookmakers"][0]["markets"][0]["outcomes"][2]["price"]
